...
--
-- Hôte : db
-- Généré le : lun. 31 oct. 2022 à 09:03
...
--
-- Structure de la table `apprenants_groupe`
--
...
--
-- Index pour la table `apprenants_groupe`
--
...
--
-- Contraintes pour la table `apprenants_groupe`
--
ALTER TABLE `apprenants_groupe`
  ADD CONSTRAINT `apprenants_groupe_ibfk_1` FOREIGN KEY (`id_apprenant`) REFERENCES `apprenants` (`id_apprenant`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `apprenants_groupe_ibfk_2` FOREIGN KEY (`id_groupe`) REFERENCES `groupe` (`id_groupe`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
